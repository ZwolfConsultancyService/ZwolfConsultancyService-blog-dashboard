...
// CATEGORY IMPORT
// ==========================================
// Path apne project ke according change karo
...
const BlogForm = () => {
  ...
  const [createBlog, { isLoading: isCreating }] =
    useCreateBlogMutation();
  ...
  useEffect(() => {
    if (isEditing && blogData?.data) {
      ...
      // Categories are already strings
      setValue(
        "categories",
                ...
                (category) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {isSelected && (
                        <span className="ml-2 flex items-center justify-center w-5 h-5 bg-indigo-600 text-white rounded-full text-xs">
                          ✓
                        </span>
                      )}
                    </button>
